    ...
    <div class="container">
        <div class="row">
            <div class="page-head-content">
                <h1 class="page-title">Motawada Group</h1>
                <img style="    margin-left: 43px;" src="assets/img/companies logo/متواضع.png" alt="">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="blog-asside-right pr0">
                <div class="panel panel-default sidebar-menu wow fadeInRight animated" >
                    ...
                    <div class="panel-body search-widget">
                        <p><i class='bx bxs-phone-call'></i><a href="tel:1234567890">01155555882</a></p>

    <p><i class='bx bxl-gmail'></i><a>elmaleka@metwade3group.com</a></p>
    <p class="location"><i class='bx bxs-location-plus'></i><a>Elobor city, --seven Area-3255</a></p>
                    ...
                    <div class="col-sm-6 col-md-4 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="/property/1" ><img src="assets/img/demo/property-3.jpg"></a>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="/property/1" ><img src="assets/img/demo/property-2.jpg"></a>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="/property/1" ><img src="assets/img/demo/property-1.jpg"></a>
                                </div>
